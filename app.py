...
def predict_note_authentication(UserID,Age,EstimatedSalary,Gender):
...
def main():
   ...
   """
    ...
    if st.button("Predict"):
      result=predict_note_authentication(UserID,Age,EstimatedSalary,Gender)
      st.success('Model has predicted {}'.format(result))
    if st.button("About"):
      st.subheader("Developed by Kratika Kumawat")
